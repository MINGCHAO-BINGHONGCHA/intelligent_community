...
class MainGenerator(XMLGenerator):
    ...
    def writeMainLaunch(self, path):
        ...
        # include
        include = MainGenerator.createElement("include", props={"file": "$(find sim_env)/launch/config_self.launch"})
...
main_gen = MainGenerator(PedGenerator(),
                         RobotGenerator(),
                         ObstacleGenerator())
main_gen.writeMainLaunch(main_gen.root_path + "sim_env/launch/main_self.launch")
